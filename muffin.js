...
app.get("/api/admin/person/get_person_episode/:episodeId", m.user_ctrl.check_if_logged, m.person_ctrl.get_person_episode)
app.delete("/api/admin/person/delete_person_episode/:id", m.user_ctrl.check_if_logged, m.person_ctrl.delete_person_episode);
app.post("/api/admin/person/add_person_episode", m.user_ctrl.check_if_logged, m.person_ctrl.add_person_episode);
app.post("/api/admin/person/edit_person_episode/:id", m.user_ctrl.check_if_logged, m.person_ctrl.edit_person_episode);
